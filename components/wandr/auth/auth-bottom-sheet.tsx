...
import { Sheet, SheetView, SheetRef } from '@/components/ui/sheet';
...
export function AuthBottomSheet({
  ...
  return (
    <Sheet
      ...
      onClose={onClose}>
      <SheetView style={[styles.sheetBody, { paddingBottom: Math.max(insets.bottom, 12) }]}>
    ...
    <AuthFormShell
      ...
      {step === 1 ? (
        <>
          ...
          />
          <ThemedText lightColor={palette.textMuted} darkColor={palette.textMuted} style={styles.helperText}>
