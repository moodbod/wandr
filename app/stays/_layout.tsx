...
export default function StaysLayout() {
  ...
  return (
    <Stack
      ...
      <Stack.Screen name="map-search" options={{ title: 'Map search', ...hiddenTitleOptions }} />
      <Stack.Screen name="details" options={{ title: 'Stay details', ...hiddenTitleOptions }} />
    </Stack>
  );
}
